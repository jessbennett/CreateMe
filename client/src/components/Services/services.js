...
class Services extends Component {
    ...
    render() {
        ...
        <h2 className="textHeader">E-Commerance</h2>
        <p className="text"><strong>E-Commerance</strong>, is online shopping as we commonly know it. Typically, we create our online shopping sites in PHP or custom Javascript.</p>
        <br/>
        <br/>
        <h3 className="textHeader">Mobile Apps</h3>
        <p className="text">A <strong>mobile app</strong> is a software program you can download and access directly using your phone or another mobile device. We build mobile apps as a cross platform; meaning applications are built with the capability of running on IOS and Andriod</p>
        <br/>
        <br/>
        <h3 className="textHeader">Digital Marketing</h3>
        <p className="text">For our <strong>Digital Marketing</strong> services, we monitor things like what is being viewed, optimizing search engine support, sales conversions, what content works and doesn’t work, etc. This is ideal for e-commerance and sales</p>
        <br/>
        <br/>
